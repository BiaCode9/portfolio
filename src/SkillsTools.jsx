      ...
      <div className="main-skills">
        ...
        <div className="skills-tools-container">
          ...
          <ul className="about-skill-list">
            ...
            <li>FIGMA<img className="icon-figma" alt="icon-figma" src='https://i.imgur.com/ld16pHL.png'></img></li>
            {/* <li>PHOTOSHOP<img className="icon-photoshop" alt="icon-photoshop" src='https://i.imgur.com/spVNuCw.png'></img></li> */}
            <li>ADOBE CREATIVE CLOUD<img className="icon-adobe" alt="icon-adobe" src='https://i.imgur.com/G367NGy.png'></img></li>
